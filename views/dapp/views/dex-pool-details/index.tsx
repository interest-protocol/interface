...
const DEXPoolDetailsView: FC<DEXPoolDetailsViewProps> = ({ pairAddress }) => {
    ...
    () => [
      {
        ...
        Icon: (
          <Box as="span" display="inline-flex" width="1rem">
            <FirstIcon width="100%" maxSize="1rem" />
          </Box>
        ),
      ...
      },
      {
        ...
        Icon: (
          <Box as="span" display="inline-flex" width="1rem">
            <SecondIcon width="100%" maxSize="1rem" />
          </Box>
        ),
  ...
  if (error)
    return (
      ...
      >
        <Box color="error">
          <TimesSVG width="10rem" maxSize="10rem" />
        </Box>
    ...
    <Container dapp mt="XXL" width="100%">
      ...
      <Box display="flex" alignItems="center">
        {processedData.loading ? (
          ...
          <>
            <FirstIcon width="2rem" maxSize="2rem" />
            <SecondIcon width="2rem" maxSize="2rem" />

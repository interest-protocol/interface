      ...
      >
        ...
        >
          ...
          <BitcoinOrbit
            ...
            filter="drop-shadow(-2px 50px 10px #0002)"
          >
            <ResponsiveImage alt="BTC" width="100%" path="home/earn-bitcoin" />
          </BitcoinOrbit>
          <BinanceOrbit
            top="34%"
            left="39%"
          ...
          <TetherOrbit
            ...
            filter="drop-shadow(-2px 50px 10px #0002)"
          >
            <ResponsiveImage alt="USDT" width="100%" path="home/earn-tether" />
          </TetherOrbit>
          <USDCxETHOrbit
            top="30%"
            width="35%"
        ...
        <Box
          ...
          pb={['1.875rem', '1.875rem', '1.875rem', '2.5rem']}

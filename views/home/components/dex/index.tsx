...
const DEX: FC = () => {
  ...
  return (
    <>
      {getHomeLocaleContent('dex', locale).map((content) => (
        <Box
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  {content.stablecoin?.description}
                </Typography>
                <br />
                {content.stablecoin?.percent}
              </Typography>
            </Container>
            <Box
              mx="M"
            ...
            >
              ...
              >
                <Typography variant="title3">{content.info?.[0]}</Typography>
              </Box>
              <Box
                p="XL"
                mx="S"
              ...
              >
                <Typography variant="title3">{content.info?.[1]}</Typography>
              </Box>
            </Box>
            <Container
              px="XXL"
            ...
            >
              ...
              >
                ...
                <Typography
                  ...
                  my={['unset', 'unset', '1rem', '1rem']}
                >
                  {content.volatile?.description}
                </Typography>
                <br />
                {content.volatile?.percent}
              </Typography>
            </Container>
          </Box>
        </Box>

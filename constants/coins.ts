...
export const COIN_TYPE_TO_SYMBOL = {
  ...
  [Network.MAINNET]: {
    ...
    [COIN_TYPE[Network.MAINNET].WORMHOLE_WAVAX]: TOKEN_SYMBOL.WORMHOLE_WAVAX,
    [COIN_TYPE[Network.MAINNET].WORMHOLE_WFTM]: TOKEN_SYMBOL.WORMHOLE_WFTM,
    [COIN_TYPE[Network.MAINNET].WORMHOLE_WBNB]: TOKEN_SYMBOL.WORMHOLE_WBNB,
    [COIN_TYPE[Network.MAINNET].WORMHOLE_CELO]: TOKEN_SYMBOL.WORMHOLE_CELO,
    [COIN_TYPE[Network.MAINNET].WORMHOLE_WMATIC]: TOKEN_SYMBOL.WORMHOLE_WMATIC,
    ...
    [COIN_TYPE[Network.MAINNET].V_LP_SUI_WORMHOLE_WMATIC]:
      TOKEN_SYMBOL.V_LP_SUI_WORMHOLE_WMATIC,
    [COIN_TYPE[Network.MAINNET].V_LP_SUI_WORMHOLE_WBNB]:
      TOKEN_SYMBOL.V_LP_SUI_WORMHOLE_WBNB,
    [COIN_TYPE[Network.MAINNET].V_LP_SUI_WORMHOLE_WAVAX]:
      TOKEN_SYMBOL.V_LP_SUI_WORMHOLE_WAVAX,
    [COIN_TYPE[Network.MAINNET].V_LP_SUI_WORMHOLE_WFTM]:
      TOKEN_SYMBOL.V_LP_SUI_WORMHOLE_WFTM,
    [COIN_TYPE[Network.MAINNET].V_LP_SUI_WORMHOLE_CELO]:
...
export const COIN_DECIMALS = {
  ...
  [Network.MAINNET]: {
    ...
    [COIN_TYPE[Network.MAINNET].WORMHOLE_WBNB]: 8,
    [COIN_TYPE[Network.MAINNET].WORMHOLE_WMATIC]: 8,
    [COIN_TYPE[Network.MAINNET].WORMHOLE_CELO]: 8,
    [COIN_TYPE[Network.MAINNET].WORMHOLE_WFTM]: 8,
    [COIN_TYPE[Network.MAINNET].WORMHOLE_WAVAX]: 8,
    ...
    [COIN_TYPE[Network.MAINNET].V_LP_SUI_WORMHOLE_WMATIC]: 0,
    [COIN_TYPE[Network.MAINNET].V_LP_SUI_WORMHOLE_WBNB]: 0,
    [COIN_TYPE[Network.MAINNET].V_LP_SUI_WORMHOLE_WAVAX]: 0,
    [COIN_TYPE[Network.MAINNET].V_LP_SUI_WORMHOLE_WFTM]: 0,
    [COIN_TYPE[Network.MAINNET].V_LP_SUI_WORMHOLE_CELO]: 0,
  },
};
...
export const COINS = {
  ...
  [Network.MAINNET]: {
    ...
    V_LP_SUI_WORMHOLE_WAVAX: {
      ...
      type: COIN_TYPE[Network.MAINNET].V_LP_SUI_WORMHOLE_WAVAX,
    },
    V_LP_SUI_WORMHOLE_WBNB: {
      decimals:
        COIN_DECIMALS[Network.MAINNET][
      ...
      type: COIN_TYPE[Network.MAINNET].V_LP_SUI_WORMHOLE_WBNB,
    },
    V_LP_SUI_WORMHOLE_WFTM: {
      decimals:
        COIN_DECIMALS[Network.MAINNET][
          COIN_TYPE[Network.MAINNET].V_LP_SUI_WORMHOLE_WFTM
        ],
      symbol: TOKEN_SYMBOL.V_LP_SUI_WORMHOLE_WFTM,
      type: COIN_TYPE[Network.MAINNET].V_LP_SUI_WORMHOLE_WFTM,
    },
    V_LP_SUI_WORMHOLE_WMATIC: {
      decimals:
        COIN_DECIMALS[Network.MAINNET][
      ...
      type: COIN_TYPE[Network.MAINNET].V_LP_SUI_WORMHOLE_WMATIC,
    },
    V_LP_SUI_WORMHOLE_CELO: {
      decimals:
        COIN_DECIMALS[Network.MAINNET][
      ...
      type: COIN_TYPE[Network.MAINNET].V_LP_SUI_WORMHOLE_CELO,
    },
  },
};
...
export const COIN_TYPE_TO_COIN = {
  ...
  [Network.MAINNET]: {
    ...
    [COIN_TYPE[Network.MAINNET].WORMHOLE_WFTM]:
      COINS[Network.MAINNET].WORMHOLE_WFTM,
    [COIN_TYPE[Network.MAINNET].WORMHOLE_WBNB]:
      COINS[Network.MAINNET].WORMHOLE_WBNB,
    [COIN_TYPE[Network.MAINNET].WORMHOLE_CELO]:
      COINS[Network.MAINNET].WORMHOLE_CELO,
    [COIN_TYPE[Network.MAINNET].WORMHOLE_WAVAX]:
      COINS[Network.MAINNET].WORMHOLE_WAVAX,
    [COIN_TYPE[Network.MAINNET].WORMHOLE_WMATIC]:
      COINS[Network.MAINNET].WORMHOLE_WMATIC,
    [COIN_TYPE[Network.MAINNET].S_LP_WORMHOLE_USDC_WORMHOLE_USDT]:
    ...
    [COIN_TYPE[Network.MAINNET].V_LP_SUI_WORMHOLE_WAVAX]:
      COINS[Network.MAINNET].V_LP_SUI_WORMHOLE_WAVAX,
    [COIN_TYPE[Network.MAINNET].V_LP_SUI_WORMHOLE_WFTM]:
      COINS[Network.MAINNET].V_LP_SUI_WORMHOLE_WFTM,
    [COIN_TYPE[Network.MAINNET].V_LP_SUI_WORMHOLE_WMATIC]:
      COINS[Network.MAINNET].V_LP_SUI_WORMHOLE_WMATIC,
    [COIN_TYPE[Network.MAINNET].V_LP_SUI_WORMHOLE_CELO]:
      COINS[Network.MAINNET].V_LP_SUI_WORMHOLE_CELO,
    [COIN_TYPE[Network.MAINNET].V_LP_SUI_WORMHOLE_WBNB]:
      COINS[Network.MAINNET].V_LP_SUI_WORMHOLE_WBNB,
  },
};

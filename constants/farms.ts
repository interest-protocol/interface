...
export const CASA_DE_PAPEL_FARM_RESPONSE_MAP = {
  [CHAIN_ID.BNB_TEST_NET]: {
    baseTokens: [ERC_20_DATA[CHAIN_ID.BNB_TEST_NET][TOKEN_SYMBOL.BTC]],
    pools: [
      {
        pair: sortERC20(
          ERC_20_DATA[CHAIN_ID.BNB_TEST_NET][TOKEN_SYMBOL.BTC],
          ERC_20_DATA[CHAIN_ID.BNB_TEST_NET][TOKEN_SYMBOL.INT]
        ),
      ...
      },
      {
        pair: sortERC20(
          ERC_20_DATA[CHAIN_ID.BNB_TEST_NET][TOKEN_SYMBOL.BTC],
          ERC_20_DATA[CHAIN_ID.BNB_TEST_NET][TOKEN_SYMBOL.DNR]
        ),
        address: ethers.utils.getAddress(
...
export const CASA_DE_PAPEL_FARM_MAP = {
  [CHAIN_ID.BNB_TEST_NET]: {
    ...
    baseTokens: [getBTCAddress(CHAIN_ID.BNB_TEST_NET)],
    poolIds: [0, 1],

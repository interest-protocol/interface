...
const BNB: FC<SVGAttributes<SVGSVGElement>> = (props) => (
  <svg
    id="binance-coin-bnb_svg__Layer_1"
    data-name="Layer 1"
  ...
  >
    <defs>
      <style>{'.binance-coin-bnb_svg__cls-1{fill:#f3ba2f}'}</style>
    </defs>
    <g id="binance-coin-bnb_svg__Layer_2" data-name="Layer 2">
      <g id="binance-coin-bnb_svg__Layer_1-2" data-name="Layer 1-2">
        <path
          className="binance-coin-bnb_svg__cls-1"

...
const PT: FC<SVGAttributes<SVGSVGElement>> = (props) => (
  <svg id="flag-icons-pt" viewBox="0 0 640 480" {...props}>
    ...
    <g transform="translate(0 26.7) scale(1.06667)">
      ...
      <g id="e">
        <g id="d" fill="#ff0" stroke="#000" strokeWidth=".5">
          ...
          <use xlinkHref="#a" width="100%" height="100%" x="10.6" />
          <path
            id="b"
            d="M186.3 139h1.2v1h.9v-1h1.2v1h.9v-1h1.2v2c0 .4-.2.6-.5.6h-4.3a.6.6 0 0 1-.6-.6v-2z"
          />
          <use xlinkHref="#b" width="100%" height="100%" x="10.6" />
          <path
            fill="#000"
            stroke="none"
          ...
          />
          <use xlinkHref="#c" width="100%" height="100%" x="10.6" />
        </g>
        <use xlinkHref="#d" width="100%" height="100%" y="46.3" />
        <use
          xlinkHref="#d"
          width="100%"
          height="100%"
      ...
      <use xlinkHref="#d" width="100%" height="100%" x="45.7" />
      <use
        xlinkHref="#e"
        width="100%"
        height="100%"
      ...
      <use xlinkHref="#f" width="100%" height="100%" y="-26" />
      <use xlinkHref="#f" width="100%" height="100%" x="-20.8" />
      <use xlinkHref="#f" width="100%" height="100%" x="20.8" />
      <use xlinkHref="#f" width="100%" height="100%" y="25.8" />
    </g>
  </svg>
);
